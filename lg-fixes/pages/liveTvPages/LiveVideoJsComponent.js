    ...
    if (isTsStream && typeof flowplayer !== "undefined") {
      ...
      if (fpContainer) {
        ...
        window.livePlayer = {
          ...
          isFullscreen() {
            try {
              const pc = document.getElementById("lp-player-container");
              return pc && pc.classList.contains("fullscreen-mode");
            } catch {
              return false;
            }
          },
          requestFullscreen() {
            try {
              const pc = document.getElementById("lp-player-container");
              if (pc && !pc.classList.contains("fullscreen-mode")) {
                pc.classList.add("fullscreen-mode");
          ...
          exitFullscreen() {
            try {
              const pc = document.getElementById("lp-player-container");
              if (pc && pc.classList.contains("fullscreen-mode")) {
                pc.classList.remove("fullscreen-mode");
                document.dispatchEvent(new Event("fullscreenchange"));
              }
            } catch {}
          },
        ...
        const handleFullscreenChange = () => {
          ...
          const isFs =
            ...
            typeof window.livePlayer.isFullscreen === "function"
              ...
              : false;
          const isCssFs = document
            .getElementById("lp-player-container")
            ?.classList.contains("fullscreen-mode");

          if (channelNameEl)
            channelNameEl.style.display = isFs || isCssFs ? "none" : "flex";
          if (liveBadgeEl) liveBadgeEl.style.display = "flex";
        };
