function LivePage() {
  ...
  const playChannel = (stream) => {
    ...
    try {
      ...
      const useTizenPlayer = isTizenDevice();
      const playerType = useTizenPlayer ? "avplay" : "videojs";
      ...
      if (
        ...
        const playerMarkup =
          useTizenPlayer && typeof LiveAvPlayer === "function"
            ? LiveAvPlayer(
                stream.stream_id,
                liveVideoUrl,
                stream.stream_icon,
  ...
  const togglePlayPauseGlobal = () => {
    ...
    if (typeof window.livePlayer.togglePlayPause === "function") {
      ...
      const isPaused = (typeof window.livePlayer.paused === "function") 
