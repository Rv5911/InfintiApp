    ...
    if (idx >= 0 && arr[idx]) {
      ...
      if (cls === "focused" && el.classList.contains("series-card") && arr[0]) {
        ...
        marqueeAnimationFrame = requestAnimationFrame(() => {
          ...
          updateMarqueeState(el, ".series-card-title span");
        });
      }
      ...
      if (cls === "series-channel-category-focused") {
        ...
        marqueeAnimationFrame = requestAnimationFrame(() => {
          if (
            !el.isConnected ||
            !el.classList.contains("series-channel-category-focused")
          )
            return;
          updateMarqueeState(el, ".series-channel-category-name span");
        });
      }
      ...
      if (isDown) {
        ...
        if (!inSeriesChannelList && focusedSeriesCardIndex >= 0) {
          ...
          <div class="series-card-bottom-content ${
            ...
            <p class="series-card-title"><span data-title="${s.name}">${s.name}</span></p>
            <p class="series-card-description">${s.name}</p>
          </div>
          <div class="series-card-top-content">
